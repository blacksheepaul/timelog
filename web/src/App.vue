          ...
          <div class="flex items-center">
            ...
            <nav class="hidden md:flex space-x-8">
              ...
              <router-link
                to="/timelogs"
                class="text-gray-500 hover:text-gray-900 px-3 py-2 text-sm font-medium transition-colors"
                :class="{ 'text-blue-600 font-semibold': $route.name === 'TimeLog' }"
              >
                Time Logs
              </router-link>
              <router-link
              ...
              <router-link
                to="/statistics"
                class="text-gray-500 hover:text-gray-900 px-3 py-2 text-sm font-medium transition-colors"
                :class="{ 'text-blue-600 font-semibold': $route.name === 'Statistics' }"
              >
                Statistics
              </router-link>
            </nav>
        ...
        <div v-if="mobileMenuOpen" class="md:hidden border-t border-gray-200 py-4">
          <nav class="space-y-1">
            ...
            <router-link
              to="/timelogs"
              class="block px-3 py-2 text-base font-medium text-gray-500 hover:text-gray-900 hover:bg-gray-50 transition-colors"
              :class="{ 'text-blue-600 bg-blue-50': $route.name === 'TimeLog' }"
              @click="mobileMenuOpen = false"
            >
              Time Logs
            </router-link>
            <router-link
              to="/tags"
              class="block px-3 py-2 text-base font-medium text-gray-500 hover:text-gray-900 hover:bg-gray-50 transition-colors"
              :class="{ 'text-blue-600 bg-blue-50': $route.name === 'Tags' }"
              @click="mobileMenuOpen = false"
            >
              Tags
            </router-link>
            <router-link
              to="/statistics"
              class="block px-3 py-2 text-base font-medium text-gray-500 hover:text-gray-900 hover:bg-gray-50 transition-colors"
              :class="{ 'text-blue-600 bg-blue-50': $route.name === 'Statistics' }"
              @click="mobileMenuOpen = false"
            >
              Statistics
            </router-link>
